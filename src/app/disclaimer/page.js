...
export const metadata = buildMetadata({
  title: "Disclaimer | AI Tech Tactics",
  description:
    "Read the AI Tech Tactics disclaimer covering content accuracy, external links, affiliate disclosures, and tool limitations.",
  path: "/disclaimer",
});
